  ...
  return (
    <section className={active !== null ? "sm:hidden lg:block" : "sm:h-screen"}>
      <nav className="lg:fixed flex flex-col bg-gray-300 lg:h-screen lg:w-60 class space-y-6 overflow-auto scrollbar-hide sm:relative sm:w-screen sm:space-y-2 sm:h-90">
        <div
          className="lg:hidden sm:block absolute right-0 hover:bg-red-300"
          onClick={onNavhide}
        >
          <IoMdClose size={20} />
        </div>
        <div className="h-auto sm:flex sm:flex-col sm:justify-center lg:justify-center space-y-2 items-center my-10  lg:navbar">
          ...
          <img
            src={promage}
            className="round border-2 border-blue-400 sm:w-20 lg:w-30"
          />
              ...
              return (
                <div className="lg:text-lg space-x-2 sm:text-sm">
                  <Link
                    ...
                    className={
                      active === item.path
                        ? "flex flex-row text-lg space-x-2 font-serif text-blue-800 border-b-2 border-blue-700"
                        : " flex flex-row space-x-2 font-serif hover:text-blue-400 hover:border-b-2 hover:border-blue-300"
                    }
                  >
                    <span
                      className={
                        active === item.path ? "text-blue-800" : "text-blue-400"
                      }
                    >
                      {item.icon}
                    </span>
